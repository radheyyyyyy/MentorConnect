...
function Rating() {
  return (
    <div>
        <div className="flex flex-col max-w-xl shadow-sm rounded-xl p-7 dark:bg-gray-50 dark:text-gray-800">
	<div className="flex flex-col w-10l">
		<h2 className="text-1xl font-semibold text-center ">Mentees reviews</h2>
